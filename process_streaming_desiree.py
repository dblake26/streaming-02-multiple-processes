...
INPUT_FILE_NAME = "storygraph_export.csv"
...
def prepare_message_from_row(row):
    ...
    Title, Authors, Contributors, ISBN_UID, Format, ReadStatus, DateAdded, LastDateRead = row
    # use an fstring to create a message from our data
    # notice the f before the opening quote for our string?
    fstring_message = f"[{Title}, {Authors}, {Contributors}, {ISBN_UID}, {Format}, {ReadStatus}, {DateAdded}, {LastDateRead}]"
